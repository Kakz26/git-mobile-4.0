...
import com.example.finaldicoding.Animal
import com.example.finaldicoding.R
import android.view.animation.AnimationUtils;


class ListHeroAdapter(private val context: Context, private val listHero: List<Animal>) : RecyclerView.Adapter<ListHeroAdapter.ListViewHolder>() {
    private lateinit var onItemClickCallback: OnItemClickCallback
    private var mediaPlayer: MediaPlayer? = null

    init {

        mediaPlayer = MediaPlayer.create(context, R.raw.brich)
    }
